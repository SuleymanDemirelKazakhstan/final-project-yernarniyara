      ...
      ajax: {
		...
		builtInValidators: {
			...
			validemail: {
				...
				message: "Недействительный адрес email<!-- data-validator-validemail-message to override -->"
			},
			passwordagain: {
				name: "Passwordagain",
				type: "match",
				match: "password",
				message: "Пароли не совпадают<!-- data-validator-paswordagain-message to override -->"
			},
			positive: {
				name: "Positive",
				type: "shortcut",
			...
			required: {
				name: "Required",
				type: "required",
				message: "Обязательное поле ввода<!-- data-validator-required-message to override -->"
			},
			checkone: {
				name: "Checkone",
				type: "minchecked",
